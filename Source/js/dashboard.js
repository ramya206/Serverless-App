...
(function() {
    ...
    Dashboard.Map = function(L) {
        ...
        const iconSize = 30;
        const iconUrl = 'images/firefighter.png';
        ...
        const mapCenter = [37.3352, -121.8811];
        const mapZoom = 12;
        ...
        return {
          ...
          <table id="popUpDetails">
            ...
            <tr>
              <td class="popUpDetailsHeader">Temperature</td>
              <td>${status.Temperature} F</td>
            </tr>
            <tr>
              <td class="popUpDetailsHeader">Air Quality</td>
              <td>${status.Concentration} PPM</td>
            </tr>
            <tr>
              <td class="popUpDetailsHeader">Last Seen</td>
              <td>${status.StatusTime} </td>
            </tr>
          </table>
        `;
